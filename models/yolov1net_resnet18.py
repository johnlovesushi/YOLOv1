...
class YOLOv1_resnet18(nn.Module):
    def __init__(self,num_bboxes = 2,num_classes = 20,num_grids = 7, batch_norm=True):
        ...
        # Initialize the ResNet-18 backbone and keep all layers up to the last convolutional block
    ...
    def _make_conv_layers(self,batch_norm):
        layers = []
        temp_layers = [
            # last ResNet 18 layer consists of a (3x3, 512) conv layer, and thus we adjust it to 512
